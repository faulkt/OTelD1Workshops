...
BACKEND_FILE='install-otel-prerequisites.sh'
...
NEWUSER="otelworkshop"
NEWPWD="dynatrace"

FUNCTIONS_FILE_REPO="https://raw.githubusercontent.com/faulkt/OTelD1Workshops/main/install-otel-prerequisites.sh"
...
if [ -f "$BACKEND_FILE" ]; then
    ...
    curl -o install-otel-prerequisites.sh $FUNCTIONS_FILE_REPO
fi
